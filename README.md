Este proyecto es un **simulador de mecanografía en línea**, desarrollado como parte de un proyecto personal, que permite a los usuarios practicar y medir su velocidad y precisión al escribir. 
